...
var WordCloud =
  ...
  (function(_PureComponent) {
    ...
    function WordCloud() {
      ...
      _defineProperty(_assertThisInitialized(_this), 'canvas', createRef());
        ...
        value: function render() {
          ...
          if (WordCloudJS.isSupported) {
            ...
            if (_typeof(dimensions) === 'object' || responsiveHeight !== null) {
              wordcloud = React.createElement(Cmp, {
                ref: this.canvas,
                style: cmpStyle,
...
_defineProperty(WordCloud, 'defaultProps', {
  FallbackUI: React.createElement('div', null, 'Browser is not supported'),
  component: 'canvas',
});
